...
insert into customer2 (id, username, age) values (4,'user4', 33);
insert into customer2 (id, username, age) values (5,'user5', 34);
insert into customer2 (id, username, age) values (6,'user6', 35);
insert into customer2 (id, username, age) values (7,'user7', 36);
insert into customer2 (id, username, age) values (8,'user8', 37);
insert into customer2 (id, username, age) values (9,'user9', 38);
insert into customer2 (id, username, age) values (10,'user10', 39);
